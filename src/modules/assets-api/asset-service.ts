...
import type { AssetTransformer } from '../asset-transform/asset-transformer.ts'
...
/** The composed Asset Application API — see this module's own doc for what it wires together. */
